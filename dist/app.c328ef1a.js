...
var Particle = /*#__PURE__*/function () {
  ...
  _createClass(Particle, [{
    ...
    value: function draw(ctx) {
      ...
      ctx.fillRect(-this.size, -this.size, this.size, this.size); // ctx.drawImage(this.img,-this.size,-this.size,this.size,this.size);
...
var Sketch = /*#__PURE__*/function () {
  function Sketch() {
    ...
    loadImages(['1.png'], function (images) {
      console.log(images); // this.images = images;

      _this.img = images[0].img; // this.raf();
      // this.mousemove();
    });
  }
